                                    ...
                                    <div class="row">
                                        <div class="col-lg-3">
                                            <div class="form-group">
                                                ...
                                                <select  data-column="0" class="form-control  search-input-select searchPosition">
                                                    <option selected="" value="">Select Position</option>
                                                    <?php
                                                    foreach ($get_position->result() as $gpos) { ?>
                                                            <?php if($gpos->position == "Applicant"){}else{?>
                                ...
                                <div class="col-lg-6">                                
                                        <div class="card-body">
                                            <div class="form-group row">
                                                <label class="col-md-2 form-control-label">Agency Name</label>
                                                <div class="col-md-4">
                                                    <input type="hidden" name="agency_name" class="agency_name">
                                                    <input disabled id="inputHorizontalSuccess" type="text" class="form-control form-control-success info_aname" name="info_aname">
                                                </div>
                                            </div>
                                        </div>                     
                                </div>
