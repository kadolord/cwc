...
<div class="content-inner" id="pageActive" data-num="4" data-namecollapse="#settings-collapse" data-labelname="Accounts"> 
    <!-- Page Header-->
    <header class="page-header">
        <div class="container-fluid">
            <h2 class="no-margin-bottom">Agencies</h2>
        </div>
    </header>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <!-- <table class="table table-striped table-hover"> -->
                                <button data-toggle="modal" data-backdrop="static" data-keyboard="false" data-target="#addAccountsModal" class="btn btn-primary btnUpdate btnTable btnClickAddAccount" name="update" style="right:20px; position: absolute; top:20px;">Add Agency</button>
        ...
        <div role="document" class="modal-dialog modal-lg modal-lg-custom">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 id="exampleModalLabel" class="modal-title">Add Agency</h4>
                                    ...
                                    <div class="">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group row">
                                                <label class="col-md-2 form-control-label">Agency Name <span class="asterisk" style="color:red">*</span></label>
                                                <div class="col-md-4">
                                ...
                                <div class="col-lg-12">
                                 ...
                                 <!--            <div class="form-group row">
                                            ...
                                            <!--     <label class="col-md-2 form-control-label">Country</label>
                                                <div class="col-md-4">
                                                    <select disabled class="form-control  info_country" name="info_country">
                                                        <?php
                                                ...
                                                <label class="col-md-2 form-control-label info_assigned_branch_container">Assigned Branch</label>
                                                <div class="col-md-4 info_assigned_branch_container">
                                                    <select disabled class="form-control  info_assigned_branch" name="info_assigned_branch">
                                                       <?php
                                                        foreach ($get_branch->result() as $gbranch) { ?>
                                                            <option value="<?=$gbranch->branch_id?>"><?=$gbranch->branch_name?></option>
                                                        <?php } ?>
                                                        ?>
                                                    </select>
                                                </div>
                            ...
                            <!--                 <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                               <!--  <label class="col-md-2 form-control-label">Country <span class="asterisk" style="color:red">*</span></label>
                                                <div class="col-md-4">
                                                    <select required class="form-control info_country" name="info_country">
                                                        <?php
                                                        foreach ($get_country->result() as $gcountry) { ?>
                                                                <option value="<?=$gcountry->country_id?>"><?=$gcountry->country?></option>
                                                        <?php } ?>
                                                ...
                                                <label class="col-md-2 form-control-label info_assigned_branch_container">Assigned Branch <span class="asterisk" style="color:red">*</span></label>
                                                <div class="col-md-4 info_assigned_branch_container">
                                                    <select required class="form-control info_assigned_branch" name="info_assigned_branch">
                                                        <?php
                                                        foreach ($get_branch->result() as $gbranch) { ?>
                                                                <option value="<?=$gbranch->branch_id?>"><?=$gbranch->branch_name?></option>
                                                        <?php } ?>
