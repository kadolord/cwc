...
<div class="content-inner" id="pageActive" data-num="4" data-namecollapse="#settings-collapse" data-labelname="Announcements"> 
    <!-- Page Header--> 
                                    ...
                                    <div class="">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-6">
                                                    <input id="inputHorizontalWarning" class="form-control form-control-warning datepicker2 info_display_date" name="info_display_date">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-10">
                                                    <textarea class="form-control form-control-warning info_content" name="info_content"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
