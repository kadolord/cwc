...
<div class="content-inner" id="pageActive" data-num="4" data-namecollapse="#settings-collapse" data-labelname="Document Type"> 
    <!-- Page Header-->
        ...
        <div role="document" class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 id="exampleModalLabel" class="modal-title">Add Document Type</h4>
                                    ...
                                    <div class="">
                                        <div class="card-body">
                                             <div class="form-group row">
                                                <label class="col-md-5 form-control-label">Document Description<span class="asterisk" style="color:red">*</span></label>
                                                <div class="col-md-7">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="">
                                        <div class="card-body">
                                            <div class="form-group row">
                                                <label class="col-md-5 form-control-label">Document ID</label>
                                                <div class="col-md-7"> 
                                            ...
                                            <div class="form-group row">
                                                <label class="col-md-5 form-control-label">Document Description</label>
                                                <div class="col-md-7">
            ...
            <div class="modal-content">
                ...
                <form class="form-horizontal personal-info-css" id="delete_accountspersonalinfo-form">
                    ...
                    <div class="modal-footer">
                        <div class="form-group row">       
                            <div class="col-md-12">
                                <button type="submit" style="float:right" class="btn btn-danger deleteReqBtn">Delete</button>
...
<script type="text/javascript" src="<?=base_url('assets/js/admin/settings/document_type.js');?>"></script>
