...
<div class="content-inner" id="pageActive" data-num="3" data-namecollapse="#settings-collapse" data-labelname="Applications"> 
    <!-- Page Header-->
        ...
        <div role="document" class="modal-dialog modal-lg modal-lg-custom">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 id="exampleModalLabel" class="modal-title">Add Application</h4>
                                    ...
                                    <div class="">
                                        <div class="card-body">
                                             <div class="form-group row">
                                                <label class="col-md-2 form-control-label">Application Name <span class="asterisk" style="color:red">*</span></label>
                                                <div class="col-md-4">
                                            ...
                                            <div class="form-group row">
                                                <label class="col-md-2 form-control-label">Bid fee <span class="asterisk" style="color:red">*</span></label>
                                                <div class="col-md-10">
                                            ...
                                            <div class="form-group row">
                                                <label class="col-md-2 form-control-label">Process <span class="asterisk" style="color:red">*</span></label>
                                                <div class="col-md-10">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="">
                                        <div class="card-body">
                                            <div class="form-group row">
                                                <label class="col-md-2 form-control-label">Application Name</label>
                                                <div class="col-md-4">
                                            ...
                                            <div class="form-group row">
                                                <label class="col-md-2 form-control-label">Bid Fee</label>
                                                <div class="col-md-4">
                                            ...
                                            <div class="form-group row">
                                                <label class="col-md-2 form-control-label">Process Fee</label>
                                                <div class="col-md-4">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="">
                                        <div class="card-body">
                                            <div class="form-group row">
                                                <label class="col-md-2 form-control-label">Applciation Name <span class="asterisk" style="color:red">*</span></label>
                                                <div class="col-md-4">
                                                    <input type="hidden" name="application_id" class="application_id">
                                                    <input required id="inputHorizontalSuccess" type="text" class="form-control form-control-success info_aname" name="info_aname">
                                                </div>
                                            ...
                                            <div class="form-group row">
                                                <label class="col-md-2 form-control-label">Process Fee <span class="asterisk" style="color:red">*</span></label>
                                                <div class="col-md-10">
                                                    <input required id="inputHorizontalWarning" type="number" class="form-control form-control-warning info_pfee" name="info_pfee">
                                                </div>
                                            </div>
    ...
    <div id="deleteAccountsModal" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
        <div role="document" class="modal-dialog modal-sm">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 id="exampleModalLabel" class="modal-title">Delete Application</h4>
                    <!-- <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true">×</span></button> -->
                </div>
