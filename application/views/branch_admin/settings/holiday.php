...
<div class="content-inner" id="pageActive" data-num="3" data-namecollapse="#settings-collapse" data-labelname="Holiday"> 
    <!-- Page Header-->
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="">
                                        <div class="card-body">
                                            <div class="form-group row">
                                                <label class="col-md-2 form-control-label">Holiday Description</label>
                                                <div class="col-md-4">
                                                    <input type="hidden" name="branch_id" class="branch_id">
                                            ...
                                            <div class="form-group row">
                                                <label class="col-md-2 form-control-label">Holiday Date</label>
                                                <div class="col-md-4">
