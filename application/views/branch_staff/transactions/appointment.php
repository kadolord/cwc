                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" data-column="2"  class="form-control material_josh form-control-sm search-input-text searchAppNo" placeholder="Reference No">
                                            </div>
                                        </div> 
...
<script type="text/javascript" src="<?=base_url('assets/js/branch_admin/transactions/appointment.js');?>"></script>
