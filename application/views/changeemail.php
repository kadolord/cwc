<!-- //kung anong laman ni login.php un ang laman nito. dagdagan lang ng notify -->
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
						...
						<div class="info d-flex align-items-center">
							...
							<div class="content">
								<div class="logo" style="">
									<img class="img-fluid" src="<?=base_url('assets/img/immigration_side_logo.png.png');?>">
									<!-- <h1>Dashboard</h1> -->
								</div>
		...
		<div role="document" class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<p class="plabel">Enter	your email address below and we'll send you a password reset instructions.</p>
					<form>
						<div class="form-group">
							<label>Enter your email address</label>
							<input type="email" placeholder="Email Address" class="input-material">
						</div>
...
<script type="text/javascript">
	$(function(){
		$.toast({
		    heading: 'Success',
		    text: 'Email address Changed! Please Sign In your account.',
		    icon: 'success',
		    loader: false,  
		    stack: false,
		    position: 'top-center', 
