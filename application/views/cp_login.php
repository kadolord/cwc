...
<body data-base_url="<?=base_url();?>">
	<div class="page login-page" style="background: url('<?=base_url()."assets/images/".$image;?>') no-repeat center center fixed">
						...
						<div class="info d-flex align-items-center">
							<div class="content">
								<div class="logo" style="">
									<a href="<?=base_url('Main/index')?>"><img class="img-fluid" src="<?=base_url('assets/img/cwc_logo.png');?>"></a>
									<!-- <h1>Dashboard</h1> -->
								</div>
		...
		<div class="copyrights text-center" >
			<p><span style="background-color: rgba(0,0,0, .6); padding: 4px;border-radius: 7px">Powered by <a href="http://cloudpanda.cloudpanda.com.ph/" class="external">Cloud Panda PH</a></span></p>
		</div>
	</div>
...
<script src="<?=base_url('assets/js/cp_login.js');?>"></script>
</body>
</html>