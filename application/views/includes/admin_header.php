        ...
        <div class="page-content d-flex align-items-stretch"> 
            ...
            <nav class="side-navbar">
                ...
                <div class="sidebar-header d-flex align-items-center">
                    <div class="avatar">
                        <img src="<?=base_url('assets/img/cwc_logo.png')?>" alt="..." class="img-fluid rounded-circle">
                    </div>
                    <div class="title">
                        <h1 class="h4"><?=$admin_info->admin_first_name?> <?=$admin_info->admin_last_name?></h1>
                        <p><?=$admin_info->position?></p>
                    </div>
                </div>
                ...
                <ul class="list-unstyled pageNavigation">
                   <!--  <li data-num="1"> 
                    ...
                    <li data-num="2">
                        <a href  = "#"> <i class="icon-interface-windows"></i>Monitoring Forms </a>
                    </li>
                           ...
                           <!--  <li><a href="<?=base_url('Main/view_admin_transactions_applicants/'.$token);?>">Agencies</a></li>
                            <li><a href="<?=base_url('Main/view_admin_transactions_applications/'.$token);?>">Year </a></li> -->
                    ...
                    <li data-num="3"> 
                        <a id="settings-collapse-a" href="#settings-collapse" aria-expanded="false" data-toggle="collapse"> <i class="icon-interface-windows"></i>Settings </a>
                        <ul id="settings-collapse" class="select-collapse collapse list-unstyled">
                            <li><a href="<?=base_url('Main/accounts/'.$token);?>">Agencies</a>

                            </li>
                            <li><a href="#">Indicators</a></li>
                            <!-- <li><a href="<?=base_url('Main/accounts/'.$token);?>">Accounts</a></li> -->
                            <!-- <li><a href="<?=base_url('Main/applicants/'.$token);?>">Applicants</a></li> -->
                            <!--  <li><a href="<?=base_url('Main/applications/'.$token);?>">Application Category</a></li>
                                <li><a href="<?=base_url('Main/applicationfee/'.$token);?>">Application Fee</a></li>
                                <li><a href="<?=base_url('Main/announcements/'.$token);?>">Announcements</a></li>
                                <li><a href="<?=base_url('Main/branch/'.$token);?>">Branch</a></li>
                                <li><a href="<?=base_url('Main/conveniencefee/'.$token);?>">Convenience Fee</a></li>
                                <li><a href="<?=base_url('Main/country/'.$token);?>">Country</a></li>
                                <li><a href="<?=base_url('Main/document_type/'.$token);?>">Document Type</a></li>
                                <li><a href="<?=base_url('Main/generate_ereceipts/'.$token);?>">Load E-Receipts</a></li>
                                <li><a href="<?=base_url('Main/holiday/'.$token);?>">Holiday</a></li>
                                <li><a href="<?=base_url('Main/reschedule_fee/'.$token);?>">Reschedule Fee And Limit</a></li>
                                <li><a href="<?=base_url('Main/schedule/'.$token);?>">Schedule Limit</a></li> -->
                        </ul>
                    </li>
                </ul>
