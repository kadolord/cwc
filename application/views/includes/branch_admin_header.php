        ...
        <div class="page-content d-flex align-items-stretch"> 
            ...
            <nav class="side-navbar">
                ...
                <div class="sidebar-header d-flex align-items-center">
                    ...
                    <div class="title">
                        <h1 class="h4"><?=$branch_admin_info->branch_admin_first_name?> <?=$branch_admin_info->branch_admin_last_name?></h1>
                        <p><?=$branch_admin_info->position?></p>
                    </div>
                </div>
                ...
                <ul class="list-unstyled pageNavigation">
                    ...
                    <li data-num="4"> 
                        ...
                        <ul id="settings-collapse" class="select-collapse collapse list-unstyled">
                            ...
                            <!-- <li><a href="<?=base_url('Main/applications/'.$token);?>">Application</a></li> -->
