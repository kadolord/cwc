						...
						<div class="info d-flex align-items-center">
							<div class="content">
								<div class="logo" style="">
									<a href="<?=base_url('Main/index')?>"><img class="img-fluid" src="<?=base_url('assets/img/immigration_logo.png');?>"></a>
									<!-- <h1>Dashboard</h1> -->
								</div>
							...
							<div class="content">
								<form id="login-form" method="post">
									...
									<div class="form-group">
										<input id="login-username" type="email" name="loginEmail" required="" class="form-control" placeholder="Email">
										<!-- <label for="login-username" class="label-material">Email</label> -->
									</div>
									<div class="form-group">
										<input id="login-password" type="password" name="loginPassword" required="" class="form-control" placeholder="Password">
										<!-- <label for="login-password" class="label-material">Password</label> -->
									</div>
									<button id="login" href="#"  class="btn btn-primary btnLogin">Login</button>
									<!-- This should be submit button but I replaced it with <a> for demo purposes-->
								</form><a href="#" class="forgot-pass" data-toggle="modal" data-target="#myModal">Forgot Password?</a><br><small>Do not have an account? </small><a href="<?=base_url('Main/register');?>" class="signup">Register</a>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="modal-body">
					...
					<form id="reset_passForm">
						<div class="form-group">
							...
							<input type="email" name="emailAddress" placeholder="Email Address" class="form-control emailAddreset" required>
						</div>
