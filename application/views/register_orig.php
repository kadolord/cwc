						...
						<div class="info d-flex align-items-center">
							...
							<div class="content">
								<div class="logo" style="">
									<img class="img-fluid" src="<?=base_url('assets/img/immigration.png');?>">
								</div>
							</div>
						</div>
					</div> -->
								...
								<form id="register-form" method="post">
									<div class="col-lg-12">
										<div class="row row-reg">
											...
											<div class="col-lg-6">
												<div class="form-group">
													<label for="register-country" class="form-control-label col-form-label-sm">Country From<span class="text-danger">*</span></label>
		                        	...
		                        	<div style="float: right; margin-left: 7px;"> 
										<button id="register" class="btn btn-primary btnReg">Register</button>
									</div>	
									<div style="float: right;"> 
			                            <button type="button" class="btn btn-danger btnregCancel">Cancel</button>
									</div>
								</form>
							</div>
						</div>
