                        ...
                        <div class="card-body">
                            <form class="form-horizontal personal-info-css" id="personalinfo-form">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-4">
                                        <input disabled id="inputHorizontalSuccess" type="text" class="form-control form-control-success" value="<?=$staff_info->staff_first_name?>" name="info_fname"><small class="form-text">First Name <span hidden class="asterisk" style="color:red">*</span></small>
                                    </div>
                                    <div class="col-md-3">
                                        <input disabled id="inputHorizontalSuccess" type="text" class="form-control form-control-success" value="<?=$staff_info->staff_middle_name?>" name="info_mname"><small class="form-text">Middle Name</small>
                                    </div>
                                    <div class="col-md-3">
                                        <input disabled id="inputHorizontalSuccess" type="text" class="form-control form-control-success" value="<?=$staff_info->staff_last_name?>" name="info_lname"><small class="form-text">Last Name <span hidden class="asterisk" style="color:red">*</span></small>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                   <!--  <label class="col-md-2 form-control-label">Birthdate <span hidden class="asterisk" style="color:red">*</span></label>
                                    <div class="col-md-4">
                                        <input disabled id="inputHorizontalWarning" type="text" class="form-control form-control-warning datepicker" value="<?= date_format(date_create($staff_info->staff_birthdate),"m/d/Y")?>" name="info_bdate">
                                    </div> -->

                                    <label class="col-md-2 form-control-label">Contact No. <span hidden class="asterisk" style="color:red">*</span></label>
                                    <div class="col-md-4">
                                        <input disabled id="inputHorizontalWarning" type="text" class="form-control form-control-warning" value="<?=$staff_info->staff_contact_num?>" name="info_contact_num">
                                    </div>
                                </div>
...
<!--                                 <div class="form-group row">
                                    ...
                                    <div class="col-md-4">
                                        <select disabled class="form-control select2" name="info_country">
                                            ...
                                            foreach ($get_country->result() as $gcountry) { ?>
                                                <?php if($gcountry->country_id == $staff_info->staff_country_id){ ?>
                               ...
                               <!--  <div class="form-group row">
                                    ...
                                    <?php if($staff_info->staff_gender_id == 1){ //male?> 
                                    <div class="col-md-2">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input disabled id="inputHorizontalWarning" type="text" class="form-control form-control-warning emailAdd" value="<?=$staff_info->staff_email?>" name="info_emailaddress_2">
                                    </div>
                                </div>
