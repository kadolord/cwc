$(function(){
	...
	var dataTable = $('#table-grid').DataTable({
		...
		"serverSide": true,
		"columnDefs": [
    		{ targets: [4,1,2], orderable: false, "sClass":"text-center" }
		],
		"ajax":{
	...
	$('.info_position').on('change', function(){
		var checker = $(this).val();
		if(checker == 3 || checker == 5){
			
			$('.info_add_branch_assignment').css('display','block');
		}else{
			
			$('.info_add_branch_assignment').css('display','none');
		}
	});
